...
def dashboard(request):
    ...
    if not can_access_dashboard(user):
        ...
        return redirect(AccountURLConstants.permission_error)
    ...
    is_admin = request.user.is_superuser or request.user.requested_role in ['admin', 'SCHOOL_ADMIN', 'PLATFORM_SUPER_ADMIN']
